import { copyPropsTo, isArray, isAttrAnEvent, isFunction, isInvalid, isNull, isNullOrUndef, isNumber, isObject, isString, isStringOrNumber, isUndefined, NO_OP, throwError } from 'inferno-shared';
import VNodeFlags from 'inferno-vnode-flags';
import options from '../core/options';
import { cloneVNode, createTextVNode, createVoidVNode, isVNode } from '../core/VNodes';
import { booleanProps, delegatedProps, isUnitlessNumber, namespaces, skipProps, strictProps } from './constants';
import { handleEvent } from './events/delegation';
import { mount, mountArrayChildren, mountComponent, mountElement, mountFunctionalComponentCallbacks, mountRef, mountText, mountVoid } from './mounting';
import { appendChild, createFunctionalComponentInput, insertOrAppend, isKeyed, removeAllChildren, replaceChild, replaceLastChildAndUnmount, replaceVNode, replaceWithNewNode, setTextContent, updateTextContent, EMPTY_OBJ } from './utils';
